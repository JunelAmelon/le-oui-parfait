  ...
  <div className="container mx-auto px-4 lg:px-6 max-w-7xl">
      ...
      <AnimatedSection direction="up">
        <div className="bg-white shadow-xl border-2 border-gray-300 overflow-hidden">
          ...
          <div className="relative p-6">
            ...
            {/* eucalyptus mobile x2 */}
            <div className="absolute -top-10 -right-6 w-32 h-52 z-10">
              <Image
            ...
            <h2 className="heading-main text-3xl mb-6">
    ...
    <div className="hidden lg:grid grid-cols-12 items-center">
      ...
      <div className="lg:col-span-7 relative h-[700px]">
        ...
        <div className="absolute bottom-[-116px] left-[-95px] w-72 h-72 z-30">
          <Image
            src="/rose-verte.PNG"
      ...
      <div className="lg:col-span-5 relative">
        ...
        <div className="bg-white p-12 shadow-2xl -ml-24 relative z-10 my-20">
          ...
          {/* eucalyptus x2 */}
          <div className="absolute -top-12 -right-8 w-40 h-64 z-20">
            <Image
              src="/decoration-eucalyptus.PNG"
              alt="Décoration eucalyptus"
              fill
