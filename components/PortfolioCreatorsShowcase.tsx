          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6">
              <div className="grid grid-cols-2 gap-4">
                {[
                  { src: '/wedding (2).jpg', alt: 'Portfolio — image 1' },
                  { src: '/wedding (3).jpg', alt: 'Portfolio — image 2' },
                  { src: '/wedding (4).jpg', alt: 'Portfolio — image 3' },
                  { src: '/wedding (5).jpg', alt: 'Portfolio — image 4' },
                ].map((img, i) => (
